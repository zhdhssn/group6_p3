...
do $env(UVMF_VIP_LIBRARY_HOME)/interface_packages/controller_in_pkg/compile.do
do $env(UVMF_VIP_LIBRARY_HOME)/interface_packages/controller_out_pkg/compile.do

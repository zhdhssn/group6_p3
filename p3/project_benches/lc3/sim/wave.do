...
add wave -noupdate -divider decode_env_dec_in_agent 
add wave -noupdate /uvm_root/uvm_test_top/environment.decode_env/dec_in_agent/dec_in_agent_monitor/txn_stream
add wave -noupdate -group decode_env_dec_in_agent_bus /hdl_top/decode_env_dec_in_agent_bus/*
add wave -noupdate -divider decode_env_dec_out_agent 
add wave -noupdate /uvm_root/uvm_test_top/environment.decode_env/dec_out_agent/dec_out_agent_monitor/txn_stream
add wave -noupdate -group decode_env_dec_out_agent_bus /hdl_top/decode_env_dec_out_agent_bus/*
add wave -noupdate -divider execute_env_exe_in_agent 
add wave -noupdate /uvm_root/uvm_test_top/environment.execute_env/exe_in_agent/exe_in_agent_monitor/txn_stream
add wave -noupdate -group execute_env_exe_in_agent_bus /hdl_top/execute_env_exe_in_agent_bus/*
add wave -noupdate -divider execute_env_exe_out_agent 
add wave -noupdate /uvm_root/uvm_test_top/environment.execute_env/exe_out_agent/exe_out_agent_monitor/txn_stream
add wave -noupdate -group execute_env_exe_out_agent_bus /hdl_top/execute_env_exe_out_agent_bus/*
